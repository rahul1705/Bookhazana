...
<section id="recently-added">
    <div class="container py-5">
        <h4 class="font-rubik font-size-20">Similar Books</h4>
        <hr/>
        <!-- carousel start -->
                    ...
                    <div class="text-center">
                        ...
                        <form method="post">
                            ...
                            if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart'))??[])) {
                                ...
                                echo '<button type="submit" name="similar_submit" class="btn btn-warning font-size-12 mb-4">
                                Add to Cart
                            </button>';
                            }
                            ?>
